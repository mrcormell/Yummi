...
struct Recipe {
    ...
    static var examples: [Recipe] {
        [Recipe(name:"Prawn Fried Rice", ingredients: [Ingredient(name: "Prawns", quantity: 12, unit: "units", category: "Fish", expiry: "20/01/2024"),Ingredient(name: "Rice", quantity: 200, unit: "g", category: "Cupboard", expiry: "05/02/2024")],isFavourite: false, rating: 5),
